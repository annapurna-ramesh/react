...
function Login() {
    return (
      <div className="Login" style={{backgroundcolor: "#666666"}}>
        ...
        <div className="wrap-login100">
            <form className="login100-form validate-form">
                ...
                <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                    <input className="input100" type="email" id = "username"></input>
                ...
                <div className="container-login100-form-btn">
                    <button className="login100-form-btn" onClick={function(){login(document.getElementById('username').value,document.getElementById('password').value)}}>
                        Login
                    </button>
                </div>
